...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec  1 17:28:57 2018
...
class DataStream(object):
    def __init__(self,init_index=0,fetch_mode='random',corpus_size=50000,maxlen=20,step=3,text_path=None,
                 dir_path=None,delim='\n',load=True,cut=True):
        self.maxlen=maxlen
        self.step=step
...
class Model(object):
    ...
    def train(self,ds,em,roll=5,batch_size=4,nb_epoch=1,maxiter=30,
...
ds=DataStream(text_path=u'./data/tianlongbabu.txt')
model=Model()
